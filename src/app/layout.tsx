...
export const metadata: Metadata = {
  title: "Pizza Delight - Authentic Taste of Italy",
  description: "Pizza Delight serves the finest authentic pizza. Discover our menu and order now.",
  openGraph: {
    title: "Pizza Delight - Authentic Taste of Italy",
    description: "Pizza Delight serves the finest authentic pizza. Discover our menu and order now.",
    url: "https://pizzadelight.com",
    siteName: "Pizza Delight",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32pj8e1GcgiOEWWC6aYveoEdoWX/tmp/delicious-pizza-1761066631051-1b33f36a.jpg",
      alt: "Delicious pizza at Pizza Delight"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "Pizza Delight - Authentic Taste of Italy",
    description: "Pizza Delight serves the finest authentic pizza. Discover our menu and order now.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32pj8e1GcgiOEWWC6aYveoEdoWX/tmp/delicious-pizza-1761066631051-1b33f36a.jpg"]
  },
  robots: {
    index: true,
    follow: true
